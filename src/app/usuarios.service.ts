...
export class UsuariosService
{
  ...
  usuarios: Usuario[] = [
    ...
    { nombre: 'Antonio', apellidos: 'Majento Solero', edad: 45, foto: 'https://img.freepik.com/foto-gratis/perfil-hombre-negro_102671-4142.jpg?size=626&ext=jpg', correo: 'majento@lokom.com', descripcion: 'Soy una persona extrovertida con ganas de...', contrasenya: 'malamente', rol: false, id: 13, amigos: [ 2, 3 ] },
